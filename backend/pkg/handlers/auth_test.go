...
func TestHandler_signUp(t *testing.T) {
	type mockBehavior func(s *mock_service.MockAutorization, user models.User)
	...
	testTable := []struct {
		...
		{
			name:      "OK",
			inputBody: `{"email":"TestEmail@mail.ru", "username":"testusername", "password":"testpassword"}`,
			inputUser: models.User{
				Email:    "Test@mail.ru",
				Username: "testusername",
				Password: "testpassword",
			},
			mockBehavior: func(s *mock_service.MockAutorization, user models.User) {
		...
		},
		{
			...
			inputBody: `{"email":"TestEmail@,ail.ru", "username":"testusername", "password":"testpassword"}`,
			inputUser: models.User{
				Email:    "Test@mail.ru",
				Username: "testusername",
				Password: "testpassword",
