...
import (
	...
	restapi_todo "github.com/Njrctr/restapi-todo/models"
...
func (m *MockAutorization) CreateUser(user restapi_todo.User) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Create(userId int, list restapi_todo.TodoListCreateUpdate) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) GetAll(userId int) ([]restapi_todo.TodoList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId)
	ret0, _ := ret[0].([]restapi_todo.TodoList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockTodoList) GetById(userId, listId int) (restapi_todo.TodoList, error) {
	m.ctrl.T.Helper()
...
func (m *MockTodoList) Update(userId, listId int, input restapi_todo.UpdateListInput) error {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockTodoItem) Create(userId, listId int, item restapi_todo.TodoItem) (int, error) {
	m.ctrl.T.Helper()
...
// GetAll mocks base method.
func (m *MockTodoItem) GetAll(userId, listId int) ([]restapi_todo.TodoItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAll", userId, listId)
	ret0, _ := ret[0].([]restapi_todo.TodoItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetById mocks base method.
func (m *MockTodoItem) GetById(userId, itemId int) (restapi_todo.TodoItem, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockTodoItem) Update(userId, itemId int, input restapi_todo.UpdateItemInput) error {
	m.ctrl.T.Helper()
